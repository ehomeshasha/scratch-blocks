...
goog.base = function(a, b, c) {
  ...
  for (var f = !1, g = a.constructor; g; g = g.superClass_ && g.superClass_.constructor) if (g.prototype[b] === d) f = !0;
...
goog.Promise.prototype.removeUnhandledRejection_ = function() {
  if (0 < goog.Promise.UNHANDLED_REJECTION_DELAY) for (var a = this; a && a.unhandledRejectionId_; a = a.parent_) goog.global.clearTimeout(a.unhandledRejectionId_), a.unhandledRejectionId_ = 0;
  ...
  if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    ...
    if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
      if (!goog.events.isMarkedIeEvent_(d)) {
        ...
        for (var g = a.type, h = d.length - 1; !e.propagationStopped_ && 0 <= h; h--) e.currentTarget = d[h], c = goog.events.fireListeners_(d[h], g, !0, e), f = f && c;
...
goog.dom.getElementsByTagNameAndClass_ = function(a, b, c, d) {
  ...
  if (c) {
    a = {};
    for (f = b = 0; g = d[f]; f++) e = g.className, "function" == typeof e.split && goog.array.contains(e.split(/\s+/), c) && (a[b++] = g);
    a.length = b;
    return a
  }
  return d
...
Blockly.Xml.blockToDom = function(a, b) {
  ...
  for (e = 0; f = a.inputList[e]; e++) h = !0, f.type != Blockly.DUMMY_INPUT && (k = f.connection.targetBlock(), f.type == Blockly.INPUT_VALUE ? c = goog.dom.createDom("value") : f.type == Blockly.NEXT_STATEMENT && (c = goog.dom.createDom("statement")), g = f.connection.getShadowDom(), !g || k && k.isShadow() || c.appendChild(Blockly.Xml.cloneShadow_(g)), k && (c.appendChild(Blockly.Xml.blockToDom(k, b)), h = !1), c.setAttribute("name", f.name), h || d.appendChild(c));
...
Blockly.Block.prototype.toString = function(a, b) {
  ...
  else for (var e = 0, f; f = this.inputList[e]; e++) {
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
  ...
  for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), m = 0, n; n = b[m]; m++) if (n.isVisible()) {
...
Blockly.FieldDropdown.prototype.render_ = function() {
  if (this.visible_) {
    ...
    } else a = document.createTextNode(this.getDisplayText_()), this.textElement_.appendChild(a), this.sourceBlock_.RTL ? this.textElement_.insertBefore(this.arrow_, this.textElement_.firstChild) : this.textElement_.appendChild(this.arrow_), this.textElement_.setAttribute("text-anchor", "start"), this.textElement_.setAttribute("x", 0), this.size_.height = Blockly.BlockSvg.MIN_BLOCK_Y, this.size_.width = Blockly.Field.getCachedWidth(this.textElement_);
...
Blockly.HorizontalFlyout.prototype.layout_ = function(a, b) {
  ...
  for (var f = 0, g; g = a[f]; f++) if ("block" == g.type) {
    g = g.block;
