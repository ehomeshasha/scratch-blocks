...
Blockly.Blocks.procedures_callnoreturn = {
  ...
  setProcedureParameters_: function(a, b) {
    ...
    if (b) if (goog.array.equals(this.arguments_, a)) this.quarkIds_ = b;
      ...
      this.updateShape_();
      if (this.quarkIds_ = b) for (f = 0; f < this.arguments_.length; f++) e = this.quarkIds_[f], e in this.quarkConnections_ && (c = this.quarkConnections_[e], Blockly.Mutator.reconnect(c, this, "ARG" + f) || delete this.quarkConnections_[e]);
